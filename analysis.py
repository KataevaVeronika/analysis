...
credentials = ServiceAccountCredentials.from_json_keyfile_name('./dazzling-bird-269311-e8166e160716.json', scope)
gc = gspread.authorize(credentials)
spreadsheet_key = '1OiqKiqKL5UPcjHcfY2oSwx0lRVBzcaQVuLrSv35AI_A'

# Rerun all this to update
book = gc.open_by_key(spreadsheet_key)
worksheet = book.worksheet("Responses")
